...
"}"));
        ...
        EmployeePhoneNumberText_C->setGeometry(QRect(370, 198, 141, 31));
        ...
        EmployeeDobText_C->setGeometry(QRect(140, 278, 104, 31));
        ...
        EmployeePhoneNumberText_U->setGeometry(QRect(370, 198, 141, 31));
        ...
        EmployeePhoneNumber_U->setGeometry(QRect(320, 230, 200, 30));
        ...
        EmployeeRoleText_U->setGeometry(QRect(400, 278, 104, 31));
        ...
        EmployeeAddressText_U->setGeometry(QRect(150, 198, 104, 31));
        ...
        EmployeeSelectID_U->setGeometry(QRect(80, 3, 81, 31));
...
" #pdfClient, \n"
"#updateClient, \n"
"#sortClient,#pieChartClient,#SearchIconClient{\n"
"     border: none;\n"
"     background-color: transparent;\n"
"}\n"
"/*Create*/\n"
...
" #ClientCreateDobLine,#SearchByLabel {\n"
"     background-color: #A7C34E;\n"
"     font-fami"
                        "ly: \"helvetica\";\n"
"     font-size: 14px;\n"
...
" "));
        ...
        readBoxClient->setGeometry(QRect(420, 100, 791, 561));
        searchBarClient = new QLineEdit(page_2);
        searchBarClient->setObjectName("searchBarClient");
        searchBarClient->setGeometry(QRect(750, 120, 441, 41));
        ...
        updateClient->setObjectName("updateClient");
        updateClient->setGeometry(QRect(440, 10, 41, 41));
        ...
        pdfClient->setGeometry(QRect(570, 10, 41, 41));
        ...
        sortClient->setGeometry(QRect(310, 10, 41, 41));
        ...
        addClient->setGeometry(QRect(50, 10, 41, 41));
        ...
        tableClient->setGeometry(QRect(430, 180, 771, 461));
        ...
        SearchComboClient->setGeometry(QRect(510, 120, 151, 41));
        SearchByLabel = new QLabel(page_2);
        SearchByLabel->setObjectName("SearchByLabel");
        SearchByLabel->setGeometry(QRect(440, 120, 71, 41));
...
"								   "));
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8("../Resources/Icons/excel.png"), QSize(), QIcon::Normal, QIcon::Off);
        excelContract->setIcon(icon8);
...
"									   }"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8("../Resources/Icons/bar-chart.png"), QSize(), QIcon::Normal, QIcon::Off);
        statsContract->setIcon(icon9);
...
"								   "));
    ...
    void retranslateUi(QDialog *Dashboard)
    {
        ...
        EmployeeRole_C->setItemText(1, QCoreApplication::translate("Dashboard", "General Director", nullptr));
        EmployeeRole_C->setItemText(2, QCoreApplication::translate("Dashboard", "Customer relationship director", nullptr));
        EmployeeRole_C->setItemText(3, QCoreApplication::translate("Dashboard", "Contract administrator", nullptr));
        EmployeeRole_C->setItemText(4, QCoreApplication::translate("Dashboard", "Accident investigation manager", nullptr));
        ...
        SearchByLabel->setText(QCoreApplication::translate("Dashboard", "Search By", nullptr));
        SearchIconClient->setText(QString());
