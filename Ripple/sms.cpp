...
void SMS::sendSms(QString to, QString message) {

    QNetworkAccessManager* manager = new QNetworkAccessManager(this);
    connect(manager, &QNetworkAccessManager::finished, this, &SMS::responseReceived);
    connect(manager, &QNetworkAccessManager::finished, this, &SMS::finished);
