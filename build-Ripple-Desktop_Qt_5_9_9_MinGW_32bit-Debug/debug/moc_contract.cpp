...
QT_MOC_LITERAL(1, 9, 23), // "deleteContractRequested"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 10), // "contractId"
QT_MOC_LITERAL(4, 45, 23) // "updateContractRequested"

    },
    "contract\0deleteContractRequested\0\0"
    "contractId\0updateContractRequested"
};
...
void contract::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->deleteContractRequested((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->updateContractRequested((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (contract::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&contract::deleteContractRequested)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (contract::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&contract::updateContractRequested)) {
                *result = 1;
                return;
            }
        }
