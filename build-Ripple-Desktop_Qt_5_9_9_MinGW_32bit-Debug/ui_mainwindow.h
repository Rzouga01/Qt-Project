...
""));
        ...
        LoginPage->setStyleSheet(QLatin1String("#email, #password {\n"
"    border-radius: 25px;\n"
...
""));
        ...
        themeSlider->setObjectName(QStringLiteral("themeSlider"));
        themeSlider->setGeometry(QRect(80, 520, 111, 71));
        themeSlider->setMouseTracking(true);
        themeSlider->setStyleSheet(QStringLiteral(""));
    ...
    {
        MainWindow->setWindowTitle(QApplication::translate("MainWindow", "Login Page", Q_NULLPTR));
        ...
        dark_theme->setPlainText(QApplication::translate("MainWindow", "Dark\n"
"", Q_NULLPTR));
        light_theme->setPlainText(QApplication::translate("MainWindow", "Light\n"
"", Q_NULLPTR));
    } // retranslateUi
